...
def save_audio(data, rate,width,filename=r"e:\Codingal\AI\Module_6\Class_1\recording.wav"):######
...
def transcribe(data, rate,width,txt_filename=r"e:\Codingal\AI\Module_6\Class_1\transcription.txt"):#######
